...
bool Bishop::isLegalMove(char column, int row, vector<Piece*>piece, vector<Piece*> opponentPiece)
{
...
bool Bishop::isPathClear(char column, int row, vector<Piece*> piece, int ignorePieceIndex)
{
	int cmp = 0;
